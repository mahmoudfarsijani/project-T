...
.box_img--layout {
  @apply w-full h-0 absolute inset-0 bg-gray-900   bg-opacity-40 dark:bg-opacity-95 dark:bg-gray-500 flex justify-center items-center rounded-lg   duration-700 overflow-hidden;
}
