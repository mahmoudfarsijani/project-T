      ...
      <Row tag="ul" :is-col="true" class="gap-[10px]">
        <li class="flex flex-nowrap gap-[20px]">
          <div class="flex flex-nowrap items-center gap-[5px]">
            ...
            <span class="text-[12px] text-gray-200">
        ...
        <li class="flex flex-nowrap gap-[20px]">
          <div class="flex flex-nowrap items-center gap-[5px]">
            <span class="text-[12px] text-gray-200"> Humidity: </span>
            <span class="text-[12px] text-gray-200">
              {{ detailData.humidity }}
            </span>
          </div>
          <div class="flex flex-nowrap items-center gap-[5px]">
            <span class="text-[12px] text-gray-200"> Visibilty: </span>
            <span class="text-[12px] text-gray-200">
